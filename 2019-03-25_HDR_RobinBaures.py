# - WP1: Theoretical predictions, fit of model parameters to experimental data and (if applies) stimulus production (lead: Marseille, particip: Berlin) TO BE WRITTEN BY LAURENT, LYLE & JENS (ca. ½ page per WP)
